...
describe( 'data update classes operate as expected', () => {
	describe( 'snippet class', () => {
		test( 'bad index', () => {
			expect( () => new X32Snippet( 'blah' ) ).toThrow( X32Error )
		} )
		test( 'no title', () => {
	...
	describe( 'scene class', () => {
		test( 'bad index', () => {
			expect( () => new X32Scene( 'blah' ) ).toThrow( X32Error )
		} )
		test( 'no title', () => {
	...
	describe( 'cue class', () => {
		test( 'bad index', () => {
			expect( () => new X32Cue( 'blah', '100' ) ).toThrow( X32Error )
		} )
		test( 'bad index', () => {
			expect( () => new X32Cue( '001', 'blah' ) ).toThrow( X32Error )
		} )
		test( 'bad skip', () => {
