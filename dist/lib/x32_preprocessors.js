...
module.exports = {
    ...
    regular: {
        ...
        auxLevel: {
            ...
            props: (msgObj) => normalizeLevel(msgObj.args[0].value, msgObj.address.slice(7, 9)),
        },
        auxMute: {
            regEx: /^\/auxin\/\d{2}\/mix\/on$/,
            props: (msgObj) => normalizeMute(msgObj.args[0].value, msgObj.address.slice(7, 9)),
        },
        auxName: {
            regEx: /^\/auxin\/\d{2}\/config\/name$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(7, 9)),
        },
        busLevel: {
            regEx: /^\/bus\/\d{2}\/mix\/fader$/,
            props: (msgObj) => normalizeLevel(msgObj.args[0].value, msgObj.address.slice(5, 7)),
        },
        busMute: {
            regEx: /^\/bus\/\d{2}\/mix\/on$/,
            props: (msgObj) => normalizeMute(msgObj.args[0].value, msgObj.address.slice(5, 7)),
        },
        busName: {
            regEx: /^\/bus\/\d{2}\/config\/name$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(5, 7)),
        },
        chanLevel: {
            regEx: /^\/ch\/\d{2}\/mix\/fader$/,
            props: (msgObj) => normalizeLevel(msgObj.args[0].value, msgObj.address.slice(4, 6)),
        },
        chanMute: {
            regEx: /^\/ch\/\d{2}\/mix\/on$/,
            props: (msgObj) => normalizeMute(msgObj.args[0].value, msgObj.address.slice(4, 6)),
        },
        chanName: {
            regEx: /^\/ch\/\d{2}\/config\/name$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(4, 6)),
        },
        dcaLevel: {
            regEx: /^\/dca\/\d\/fader$/,
            props: (msgObj) => normalizeLevel(msgObj.args[0].value, msgObj.address.slice(5, 6)),
        },
        dcaMute: {
            regEx: /^\/dca\/\d\/on$/,
            props: (msgObj) => normalizeMute(msgObj.args[0].value, msgObj.address.slice(5, 6)),
        },
        dcaName: {
            regEx: /^\/dca\/\d\/config\/name$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(5, 6)),
        },
        mainLevel: {
            regEx: /^\/main\/st\/mix\/fader$/,
            props: (msgObj) => normalizeLevel(msgObj.args[0].value, '0'),
        },
        mainMute: {
            regEx: /^\/main\/st\/mix\/on$/,
            props: (msgObj) => normalizeMute(msgObj.args[0].value, '0'),
        },
        mainName: {
            regEx: /^\/main\/st\/config\/name$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, '0'),
        },
        monoLevel: {
    ...
    node: {
        auxMix: {
            regEx: /^\/auxin\/\d{2}\/mix$/,
            props: (msgObj) => normalizeMix(msgObj.args[0].value, msgObj.args[1].value, msgObj.address.slice(7, 9)),
        },
        auxName: {
        ...
        busMix: {
            regEx: /^\/bus\/\d{2}\/mix$/,
            props: (msgObj) => normalizeMix(msgObj.args[0].value, msgObj.args[1].value, msgObj.address.slice(5, 7)),
        },
        busName: {
        ...
        dcaMix: {
            regEx: /^\/dca\/\d$/,
            props: (msgObj) => normalizeMix(msgObj.args[0].value, msgObj.args[1].value, msgObj.address.slice(5, 6)),
        },
        dcaName: {
            regEx: /^\/dca\/\d\/config$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(5, 6)),
        ...
        chanMix: {
            regEx: /^\/ch\/\d{2}\/mix$/,
            props: (msgObj) => normalizeMix(msgObj.args[0].value, msgObj.args[1].value, msgObj.address.slice(4, 6)),
        },
        chanName: {
            regEx: /^\/ch\/\d{2}\/config$/,
            props: (msgObj) => normalizeName(msgObj.args[0].value, msgObj.address.slice(4, 6)),
        ...
        mainMix: {
            regEx: /^\/main\/st\/mix$/,
            props: (msgObj) => normalizeMix(msgObj.args[0].value, msgObj.args[1].value, '0'),
        },
        mainName: {
...
//# sourceMappingURL=x32_preprocessors.js.map