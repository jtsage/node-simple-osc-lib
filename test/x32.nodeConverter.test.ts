...
describe( 'converter operate as expected', () => {
	...
	test( 'cue', () => {
		...
		expect( result.address ).toEqual( '/-show/showfile/cue/000' )
	...
	test( 'scene', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/-show/showfile/scene/001' )
	...
	test( 'snippet', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/-show/showfile/snippet/000' )
	...
	test( 'show name', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/-show/showfile/show' )
	...
	test( 'show control', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/-prefs/show_control' )
	...
	test( 'mix 1', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/main/m/mix' )
	...
	test( 'mix 2', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/main/st/mix' )
	...
	test( 'mix 3', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/ch/01/mix' )
		expect( result.args ).toHaveLength( 6 )
	...
	test( 'config', () => {
		...
		const result = converter( msg, true )
		expect( result.address ).toEqual( '/main/m/config' )
		expect( result.args ).toHaveLength( 3 )
