...
export class X32Data {
	...
	constructor( value : number | string ) { this.index = X32Data.index2Number( value ) }
	...
	get zIndex() { return String( this.index ).padStart( 2, '0' ) }
}
...
export class X32FaderUpdate extends X32Data {
	...
	hasName() : this is X32FaderUpdateName { return this.#type === 'name' }
...
export class X32FaderUpdateMute extends X32FaderUpdate {
	...
	get onText() { return this.#onStatus === true ? 'ON' : 'OFF' }
	get onBool() { return this.#onStatus }
	get onInt()  { return this.#onStatus === true ? 1 : 0 }
}
...
export class X32FaderUpdateLevel extends X32FaderUpdate {
	...
	get levelDb() { return X32FaderUpdate.float2dB( this.#level ) }
...
export class X32Snippet extends X32Data {
	...
	get zIndex() { return String( this.index ).padStart( 3, '0' ) }
}
...
/** General OSC Error */
export class X32Error extends Error {
